...
<section class="back__veryBrightMarble objections_onSale">
    ...
    ?>
        ...
        <div class="objects_onSale-grid">
            <div class="grid-wrapper">
                <a style="" class="box home" href="<? echo $link_rentRoom?>?typeObjectSelect=<? echo $grid[1]['title']?>">
                ...
                <a style="" class="box lands" href="<? echo $link_rentRoom?>?typeObjectSelect=<? echo $grid[2]['title']?>">
                   
                    <div class="box_wrapper__img">
                        <img src="<?echo $grid[2]['image']; ?>" alt="img" />
                        <div class="overlay_img"></div>
                    </div>
                    <div class="services__body-wrapper objects_onSaleGrid-text">
                        <p><?echo $grid[2]['title']?></p>
                        <img class="services_svg" src="<?php echo get_template_directory_uri( )?>/assets/img/line_gold.png" alt="vector" />
                    </div>
                </a>
...
<section class="best__offers_back">
    <?php 
            ...
            if($beft_offers)
            {
                ...
                $linkSell = get_field('linksSell','option');
                ?><a href="<? echo $linkSell['link_sell'] ?>" class="a_wrapper_btn"> <button class="btn-text-gold ofc__button " onclick="redirectToCatalogSell();">Смотреть все</button> </a><?
            }
