        ...
        <div class="swiper-wrapper">
            ...
            <div class=" swiper-slide ">
                ...
                <div  style='' class="slider__right-img">
                            <img src="<?php echo $slide['image_slide']?>" alt="img" />
                                <?php
        ...
        <div class=" mb-7rem container-rentRoom">
            <div class="form_order">
                <? 
                    ...
                    if($elems_form):
                        ?>
                <form class="form" id="filters" name="filters_form">
                    ...
                    <div class="chid">
                        ...
                        <div class="multiselect_block" >
                            ...
                            ?>
                                ...
                                <?= strtolower(trim($option['name'])) == strtolower(trim($typeObj)) ? "selected" : "" ?>><? echo $option['name']?></option>
                                <?endforeach; endif; ?>
                            </select>
                        </div> 
                    </div>
...
?>
       <div class="container-catalog">
            ...
            <?
                ...
                data-tpl="card" 
                class="btn-text-black ofc__button" id="btnAddCards" type="button">Смотреть все</button> 
