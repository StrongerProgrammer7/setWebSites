...
?>
<?
    $title_projects = get_field('title');
    $background_projects = get_field('background');
    if($title_projects):
?>
            ...
            <div class="container-total">
                <div class="total_control-content">
                    <div class="tc_content-title">
                        <h1> <? echo $title_projects ?> </h1>
                    </div>
                </div>
               
            </div>
            <img src="<? echo $background_projects?>" alt="background" />
        </div>
...
<?
    ...
    $title_letterThanks = get_field('title_thanks');
    if($title_letterThanks):
        $lettersImg = get_field('letterThanks');
?>
